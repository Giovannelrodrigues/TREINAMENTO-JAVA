...
public class AmbienteTrabalho extends Auditoria {
	...
	public boolean equals(Object obj) {
		return EqualsBuilder.reflectionEquals(this, obj, "descricao", "tipo", "setores", "enderecos");
	}

	@Override
	public int hashCode() {
		return HashCodeBuilder.reflectionHashCode(this, "descricao", "tipo", "setores", "enderecos");
	}
