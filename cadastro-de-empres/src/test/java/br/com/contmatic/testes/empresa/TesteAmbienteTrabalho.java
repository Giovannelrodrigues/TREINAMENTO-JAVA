...
public class TesteAmbienteTrabalho {
	...
	public void antesDeCadaTeste() {
		...
		ambienteBefore = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
	}
	...
	public void teste01_deve_instaciar_um_ambiente_trabalho_com_campos_obrigatorios() {
		...
		assertEquals(EMAIL, ambiente.getCreatedBy());
	...
	@Test(expected = IllegalArgumentException.class)
	public void testeQ_NAO_deve_atribuir_um_novo_tipo_estabelecimento_para_ambiente_trabalho_passando_nulo() {
		ambienteBefore.setTipoEstabelecimento(null);
	}

	// LISTA SETORES
	@Test
	public void teste17_deve_atribuir_uma_nova_lista_setores_para_ambiente_trabalho() {
		List<Setor> setores = new ArrayList<Setor>();
		setores.add(new Setor(EMAIL, LOCAL_TIME , "desenvolvimento front end", ambienteBefore));
		ambienteBefore.setSetores(setores);
		assertEquals(setores, ambienteBefore.getSetores());
	}

	@Test(expected = IllegalArgumentException.class)
	public void teste18_nao_deve_atribuir_uma_nova_lista_setores_para_ambiente_trabalho_passando_nulo() {
		ambienteBefore.setSetores(null);
	}

	@Test(expected = IllegalStateException.class)
	public void teste19_nao_deve_atribuir_uma_nova_lista_setores_para_ambiente_trabalho_passando_lista_vazia() {
		ambienteBefore.setSetores(new ArrayList<Setor>());
	}

	@Test(expected = IllegalStateException.class)
	public void teste20_nao_deve_atribuir_uma_nova_lista_setores_para_ambiente_trabalho_passando_mais_de_30_ambientes() {
		List<Setor> setores = new ArrayList<Setor>();
		for (int index = 31; index != 0; index--) {
			setores.add(new Setor(EMAIL, LOCAL_TIME, NOME, ambienteBefore));
		}
		ambienteBefore.setSetores(setores);
	}
	...
	// LISTA ENDERECOS
	@Test
	public void teste21_deve_atribuir_uma_nova_lista_de_enderecos_para_ambiente_trabalho() {
		List<Endereco> enderecos = new ArrayList<Endereco>();
		enderecos.add(new Endereco(EMAIL, LOCAL_TIME, "04852510", "rua x", 194, "JD lucelia", new Estado("São Paulo"), new Cidade("São Paulo"),
	...
	@Test(expected = IllegalArgumentException.class)
	public void teste22_nao_deve_atribuir_uma_nova_lista_de_enderecos_para_ambiente_trabalho_passando_nulo() {
		ambienteBefore.setEnderecos(null);
	}

	@Test(expected = IllegalStateException.class)
	public void teste23_nao_deve_atribuir_uma_nova_lista_de_enderecos_para_ambiente_trabalho_passando_lista_vazia() {
		ambienteBefore.setEnderecos(new ArrayList<Endereco>());
	}

	@Test(expected = IllegalStateException.class)
	public void teste24_nao_deve_atribuir_uma_nova_lista_de_enderecos_para_ambiente_trabalho_passando_mais_de_5_enderecos() {
		List<Endereco> enderecos = new ArrayList<Endereco>();
	...
	// TO STRING
	@Test
	public void teste25_deve_retornar_o_nome_do_ambiente_no_to_string() {
		String result = ambienteBefore.toString();
		assertThat(result, containsString(ambienteBefore.getNome()));
	}

	@Test
	public void teste26_deve_retornar_a_descricao_do_ambiente_no_to_string() {
	...
	@Test
	public void teste27_deve_retornar_a_empresa_que_o_ambiente_pertence_no_to_string() {
		String result = ambienteBefore.toString();
		assertThat(result, containsString(String.valueOf(ambienteBefore.getEmpresa())));
	}

	@Test
	public void teste28_deve_retornar_a_lista_de_endereco_do_ambiente_no_to_string() {
		String result = ambienteBefore.toString();
		assertThat(result, containsString(String.valueOf(ambienteBefore.getEnderecos())));
	}

	@Test
	public void teste29_deve_retornar_a_lista_de_setores_do_ambiente_no_to_string() {
		String result = ambienteBefore.toString();
		assertThat(result, containsString(String.valueOf(ambienteBefore.getSetores())));
	}

	@Test
	public void teste30_deve_retornar_tipo_do_estabelecimento_do_ambiente_no_to_string() {
		String result = ambienteBefore.toString();
	...
	@Test
	public void teste31_deve_retornar_o_mesmo_hashcode_para_da_ambiente_com_mesmo_nome() {
		AmbienteTrabalho ambiente1 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
		AmbienteTrabalho ambiente2 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
	...
	// EQUALS
	@Test
	public void teste32_deve_retornar_true_quando_usar_equals_passado_ambientes_iguais() {
		AmbienteTrabalho ambiente1 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
		AmbienteTrabalho ambiente2 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
	...
	@Test
	public void teste33_deve_retornar_falso_quando_usar_equals_passado_nome_ambientes_difentes() {
		AmbienteTrabalho ambiente1 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , NOME, empresaBefore);
		AmbienteTrabalho ambiente2 = new AmbienteTrabalho(EMAIL, LOCAL_TIME , "Recursos Humanos", empresaBefore);
		boolean resp = ambiente1.equals(ambiente2);
		assertFalse(resp);
	}
